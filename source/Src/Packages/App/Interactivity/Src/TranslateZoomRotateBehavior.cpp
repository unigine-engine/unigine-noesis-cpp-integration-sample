...
{
    auto CoerceFriction = [](const DependencyObject*, const void* value, void* coercedValue) -> bool
    {
    ...
    data->RegisterProperty<float>(TranslateFrictionProperty, "TranslateFriction",
        Noesis::PropertyMetadata::Create(0.0f, Noesis::CoerceValueCallback(CoerceFriction)));
